...
Instead of using a traditional website builder, I built the site directly in source files using **Quarto**, an open-source scientific and technical publishing system. This approach integrates cleanly with data science workflows and supports direct rendering of Jupyter Notebooks and R Markdown files into polished web pages.
