...
<i class="fa-solid fa-display"></i> [View Interactive Prototype (Figma)](https://www.figma.com/proto/BnU5m8xvTo40yhVUYqnlWP/iPhone-Grid-Menu-Prototype)
:::
...
The project began with a multi-method research process to understand how users interact with the current camera interface and where friction appears.
