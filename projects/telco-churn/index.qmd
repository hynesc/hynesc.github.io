...
This project demonstrates a complete machine learning workflow for predicting customer churn at a telecom provider. It includes data cleaning, model training, feature importance analysis, and deployment of an interactive Streamlit application.
