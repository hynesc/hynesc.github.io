...
<i class="fa-brands fa-github"></i> [GitHub Repository](https://github.com/hynesc/readmission-prediction)
:::
...
The project uses the synthetic dataset published by the original authors, designed to mimic the structure of a real-world EHR dataset for Congestive Heart Failure (CHF) patients.
